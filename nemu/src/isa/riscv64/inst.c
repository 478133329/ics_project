...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("010000? ????? ????? 101 ????? 00110 11", sraiw  , I, R(rd) = SEXT((int)BITS(src1, 31, 0) >> (imm & 0x3f), 32));
  // 寄存器移位指令也是只取低六位。
  ...
  INSTPAT("0100000 ????? ????? 101 ????? 01110 11", sraw   , R, R(rd) = SEXT((int)BITS(src1, 31, 0) >> (src2 & 0x3f), 32));
